...
class _HomePageState extends State<HomePage> {
                    ...
                    child: Text.rich(
                      TextSpan(
                        children: [
                          ...
                          TextSpan(
                            text:
                                '${appLaunch?.didNotificationLaunchApp ?? false}',
                          )
                        ],
                      ),
                    ),
  ...
  Future<void> _scheduleNotification() async {
    ...
    var platformChannelSpecifics = NotificationDetails(
        androidPlatformChannelSpecifics, iOSPlatformChannelSpecifics);
    await notificationsPlugin.schedule(0, 'scheduled title', 'scheduled body',
  ...
  Future<void> _showProgressNotification() async {
    ...
    for (var i = 0; i <= maxProgress; i++) {
      await Future.delayed(Duration(seconds: 1), () async {
        ...
        var platformChannelSpecifics = NotificationDetails(
            androidPlatformChannelSpecifics, iOSPlatformChannelSpecifics);
        await notificationsPlugin.show(0, 'progress notification title',
  ...
  Future<void> _showNotificationWithAttachment() async {
    ...
    var notificationDetails = NotificationDetails(
        androidPlatformChannelSpecifics, iOSPlatformChannelSpecifics);
    await notificationsPlugin.show(0, 'notification with attachment title',
